...
import * as pipeline from "./screens/pipeline.js?v=20260719-1";
import * as thread from "./screens/thread.js?v=20260719-1";
import * as client from "./screens/client.js?v=20260719-1";
import * as settings from "./screens/settings.js?v=20260719-1";
import * as review from "./screens/review.js?v=20260719-1";
import * as sales from "./screens/sales.js?v=20260719-1";
import * as detected from "./screens/detected.js?v=20260719-1";
import * as dashboard from "./screens/dashboard.js?v=20260719-1";
import * as clients from "./screens/clients.js?v=20260719-1";
import * as scout from "./screens/scout.js?v=20260719-1";
import { setError } from "./utils.js?v=20260719-1";
import { hideBack, showBack, setTitle } from "./components/backbar.js?v=20260719-1";
