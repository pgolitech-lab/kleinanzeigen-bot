...
import { ready, startParam } from "./tg.js?v=20260719-1";
import { start as startRouter } from "./router.js?v=20260719-1";
import { mountTabbar } from "./components/tabbar.js?v=20260719-1";
import { mountBackbar } from "./components/backbar.js?v=20260719-1";
