                ...
                for row in rows:
                    ...
                    if is_new:
                        ...
                        summary["new_listings"].append({
                            ...
                            "negotiable": row["negotiable"], "url": row["url"],
                            "plz": row["plz"], "city": row["city"], "bundesland": row["bundesland"],
                            "posted_raw": row["posted_raw"], "shipping": row["shipping"],
                            "year": row["year"], "mileage_km": row["mileage_km"],
                            "fuel": row["fuel"], "gearbox": row["gearbox"],
                            "model_family": row["model_family"],
                            "part_type": row["part_type"], "condition": row["condition"],
                        })
